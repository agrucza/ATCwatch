...
class HomeScreen : public Screen
{
  public:
    virtual void pre()
    {
      ...
      lv_label_set_text_fmt(label_battery, "%s %i%%", LV_SYMBOL_BATTERY_FULL, get_battery_percent());
      lv_obj_align(label_battery, lv_scr_act(), LV_ALIGN_IN_TOP_RIGHT, 5, 5);
      ...
      style_time.text.color = lv_color_hsv_to_rgb(10, 5, 95);
      style_time.text.font = &sans_bold28;
      style_time.text.font = &mksd50;
      
      label_time = lv_label_create(lv_scr_act(), NULL);
      lv_label_set_text_fmt(label_time,  "%02i\n%02i", time_data.hr, time_data.min);
      lv_obj_set_style(label_time, &style_time);
      lv_obj_align(label_time, NULL, LV_ALIGN_IN_LEFT_MID, 20, 0);

      // text
      lv_style_copy(&style_text, &lv_style_plain);
      style_text.text.color = lv_color_hsv_to_rgb(10, 5, 95);
      /*
      style_text.text.font = &sans_regular;
      
      lv_obj_t* label_test1 = lv_label_create(lv_scr_act(), NULL);
      lv_obj_align(label_test1, NULL, LV_ALIGN_CENTER, 0, -30);
      lv_obj_set_style(label_test1, &style_text);
      lv_label_set_text(label_test1, "Dies Ist ein TÄst");
      
      style_text.text.font = &lv_font_roboto_28;
      lv_obj_t* label_test2 = lv_label_create(lv_scr_act(), NULL);
      lv_obj_align(label_test2, NULL, LV_ALIGN_CENTER, 0, -10);
      lv_obj_set_style(label_test2, &style_text);
      lv_label_set_text(label_test2, "Dies Ist ein TÄst");
      
      style_text.text.font = &sans_bold28;
      lv_obj_t* label_test3 = lv_label_create(lv_scr_act(), NULL);
      lv_obj_align(label_test3, NULL, LV_ALIGN_CENTER, 0, 10);
      lv_obj_set_style(label_test3, &style_text);
      lv_label_set_text(label_test3, "Dies Ist ein TÄst");
      */
      /*
      ...
      lv_obj_align(img_steps, NULL, LV_ALIGN_IN_BOTTOM_RIGHT, -2, -34);
  ...
  private:
    ...
    lv_style_t style_time, style_ble, style_battery, style_msg;
